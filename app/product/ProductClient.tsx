...
import { getProduct, formatPrice, HERMITAGE } from '../../lib/data';
...
export default function ProductPage() {
  ...
  const similar = HERMITAGE.products
    .filter((p) => p.id !== product.id && (p.category === product.category || p.factory === product.factory))
    .slice(0, 4);
      ...
      <div className="product-layout container" style={{ paddingTop: 0, paddingBottom: 32 }}>
        ...
        <div className="product-info">
          ...
          <div className="product-actions">
            ...
            <a
              href={`https://wa.me/${HERMITAGE.whatsapp}?text=${encodeURIComponent(
